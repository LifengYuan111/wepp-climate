...
# Original relative path: SYNTOR-SI\crp_present_from_GPCC-SI.R
# Source SHA256: 71671DDEC85EA285D7E48C45B90991CC86613B9897405FD2D865A5D8385A6349
#
...
crp_base
crp_base$downscale <- c('SYNTOR-SI')

crp_others <- crop_all[!(crop_all$Climate == 'Baseline'),]
crp_others
crp_others$downscale <- c('SYNTOR-SI')
write.csv(crp_others,'crp_others_SS.csv',row.names = F)
